...
@section('meta-description')
	<meta name="description" content="Купить мухоморы. Купить мухомор из Сибири. У нас можно купить мухоморы в Тюмени. ОПТ и Розница. Всегда в наличии. Отправка в в день заказа. Оформите заказ у нас на сайте!">
@endsection
...
@section('content')
	...
	<div class="alert alert-custom alert-secondary" role="alert">
		...
		<p>Перейти к <a href="{{route('category', 6)}}">полному каталогу</a>.</p>
		<p>
		</p>
	</div>
