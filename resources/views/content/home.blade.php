...
@section('content')
	...
	<div class="alert alert-custom alert-secondary" role="alert">
		...
		<p>
			Мухомор собирается в тайге Сибири, в экологически чистой таёжной зоне Ханты-Мансийской области. 
            Сбор производится населением Ханты в сухую погоду.
			Сушка производится в естественных условиях прямо в тайге в специальных деревянных Схронах, Мухомор перебирается 2 раза, хранится в герметичном хранилище, в огромных балаклавах.
