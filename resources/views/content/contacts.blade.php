...
@section('content')
    <div class="alert alert-custom alert-secondary info-block">
        ...
        <p>
            Если Вы заинтересовались нашей продукцией, нашими предложениями,звоните в любое время или Пишите в удобном для Вас приложении, будем рады сотрудничать с Вами.
