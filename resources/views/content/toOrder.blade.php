...
@section('content')
    <div class="alert alert-custom alert-secondary info-block">
        ...
        <p><b>3)</b> <i>Оплата.</i>  Оплата происходит после оформления заказа по указанным, после офомления заказа, реквизитам на карту Сбербанка.</p>

        <p><b>4)</b> <i>Связь.</i> После оформления заказа мы перезвоним Вам для подтверждения заказа.</p>
