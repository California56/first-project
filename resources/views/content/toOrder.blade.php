...
@section('content')
    <div class="alert alert-custom alert-secondary info-block">
        ...
        <p><b>1)</b> Выберите нужный Вам товар и добавьте его в корзину, в корзине можно установить количество товара и посмотреть итоговую стоимость заказа.
        </p>

        <p><b>2)</b>Оформление заказа. В оформлении заказа нужно будет ввести данные, необходимые для отправки заказа по Почте, а также Ваш номер телефона для того,
         чтобы мы могли уведомить Вас об отправке и сообщить трек-номер посылки.</p>

        <p><b>3)</b>Оплата. Оплата происходит после оформления заказа по указанным, после офомления заказа, реквизитам на карту Сбербанка.</p>
