...
@section('content')
    <div class="alert alert-custom alert-secondary info-block">
        ...
        <p>Выберите нужный Вам товар и добавьте его в корзину, в корзине можно установить количество товара и посмотреть итоговую стоимость заказа. Когда весь заказ уже сформирован, можно приступать к оформлению заказа.
        </p>

        <p>В оформлении заказа нужно будет ввести данные, необходимые для отправки заказа по Почте, а также Ваш номер телефона для того,
         чтобы мы могли уведомить Вас об отправке и сообщить трек-номер посылки.</p>

        <p>Оплата происходит после оформления заказа по указанным, после офомления заказа, реквизитам на карту Сбербанка.</p>

        <p>После оформления заказа мы перезвоним Вам для подтверждения заказа.</p>
