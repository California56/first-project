...
@section('content')
    <div class="alert alert-custom alert-secondary info-block">
        ...
        <br>
        <p>Если Вы по каким-то причинам не хотите оформлять заказ в интернет-магазине, то Вы всегда можете сделать заказ, просто позвонив нам по телефону или написав нам в любом удобном для Вас мессенджере по номеру <a class="link_attention" href="https://wa.me/79088769117" >8-908-876-91-17</a>.
        </p>
    </div>	
@endsection